<!--
* browser: digital-health-guide
* tracker: 4687cbdc15680c1649eac8a53722d812
* version: 1.0.0
* updated: 2026-02-10T01:55:52Z
...
Digital Health Guide: this book explains one topic per page, like a big glossary, easy wiki, quick encyclopedia, or summary notes.

- Get the book:
  [Free EPUB](https://github.com/SixArm/digital-health-guide/raw/main/digital-health-guide.epub),
  [Free PDF](https://github.com/SixArm/digital-health-guide/raw/main/digital-health-guide.pdf).
...
### [Introduction](topics/digital-health-guide-introduction)

### [HL7 FHIR](topics/hl7-fhir)

- [HL7 FHIR versions](topics/hl7-fhir-versions)
- [HL7 FHIR resources](topics/hl7-fhir-resources)
- [HL7 FHIR profiles](topics/hl7-fhir-profiles)
- [HL7 FHIR extensions](topics/hl7-fhir-extensions)

### Government regulations

- [The 21st Century Cures Act](../the-21st-century-cures-act/)
- [United States Core Data for Interoperability (USCDI)](../united-states-core-data-for-interoperability/)
- [Trusted Exchange Framework and Common Agreement (TEFCA)](../trusted-exchange-framework-and-common-agreement/)
...
- [United States National Library of Medicine (NLM)](topics/united-states-national-library-of-medicine)
- [Value Set Authority Center (VSAC)](value-set-authority-center)
